...
interface CollectionNavigationProps {
  activeSection?: 'homme' | 'femme' | 'unisexe' | 'fianka';
}
          ...
          <div className="flex h-14 items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="h-9 w-9 p-0 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-full"
