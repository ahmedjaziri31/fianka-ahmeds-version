  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Fetch homme products
        const hommeResponse = await fetch('/api/products?category=homme');
        const hommeData = await hommeResponse.json();
        ...
        // Combine: all homme products + first unisex product
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <CollectionNavigation activeSection="homme" />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            ...
            alliant élégance et confort dans un style intemporel.
          </p>
