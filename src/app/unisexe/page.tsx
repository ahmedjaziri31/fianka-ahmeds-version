  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Show only the first unisex product
        const singleProduct = unisexData.products.length > 0 ? [unisexData.products[0]] : [];
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <CollectionNavigation activeSection="unisexe" />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Découvrez notre collection unisexe, 
            parfaite pour tous avec un style polyvalent et moderne.
          </p>
